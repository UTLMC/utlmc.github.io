...
It is recommended you download this repository if you want to preview your changes without uploading to Github every single time. This is especially true when working with images (e.g. exec pictures, gallery), as you will need to ensure the image is already uploaded and formatted properly before applying your changes. To do this:
...
- The club cannot expect a steady stream of CS skill so it needs basic functionality like updating data to be accessible even without devs around.
- React and other frontend technologies all require use of the command line, which is inaccessible for non-CS students and even early CS students. Backends amplify this weakness.
